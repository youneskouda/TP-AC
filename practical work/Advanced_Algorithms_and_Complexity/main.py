...
def display_percentage(i,n,start_time):
    ...
    sys.stdout.write(f"\rProgress: {elapsed_percentage :.80f}%, Elapsed Time: {elapsed_time:.2f}s, RemainingTime: {remaining_time:.2f}s")
...
def brute_force_tsp(distances, cities):
    ...
    best_route = None
    i = 1
    permutation_length = math.factorial(n-1)
    ...
    for perm in itertools.permutations(range(1, n)):
        ...
        display_percentage(i,permutation_length,start_time)
...
def nearest_neighbor_tsp(distances, cities, start=0):
...
nn_route, nn_length = nearest_neighbor_tsp(D, cities1, start=0)

print("Nearest Neighbor Route:", nn_route)
print("Nearest Neighbor Length:", nn_length)
print("Route (cities):")
for city_index in nn_route:
    print(cities1[city_index], end=" -> ")
print("\nTotal distance:", nn_length, "km")
